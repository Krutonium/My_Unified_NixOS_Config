#!/usr/bin/env bash
#git remote add github git@github.com:Krutonium/My_Unified_NixOS_Config.git
#git remote add gitea gitea@gitea.krutonium.ca:Krutonium/My_Unified_NixOS_Config.git
